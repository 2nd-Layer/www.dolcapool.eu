      ...
      <div class="columns is-vcentered">
        ...
        <div class="column is-4">
          ...
          <h2 class="subtitle is-5 is-light is-thin">
            Cryptocurrency brought to the next level. Join our Stake Pool for
        ...
        <div class="column is-6">
          <div v-if="pool" class="box primary-gradient">
            <h2 class="title is-2 is-light is-semibold is-spaced main-title">
              Live Pool Stats
              <span class="has-text-weight-light">- Rank: {{ rank }}</span>
            </h2>
            <div class="columns is-vcentered">
              <div class="column is-6">
              ...
              <div class="column is-6">
                <p>
                  <b><abbr title="Return on Assets">RoA</abbr>:</b> {{ roa }}%
                </p>
              ...
              <div class="column is-5 is-offset-1">
                <div class="side-feature-content">
                  ...
                  <p class="is-light my-3">
                    <nuxt-link to="/dolca-stake-poool-team/">
                  ...
                  <p class="is-light my-3">
                    ...
                    IT infrastructure,
                    <nuxt-link to="/partnership-with-dCloud/">
                      Cloud
                    </nuxt-link>
                    , DevOps and
                    <nuxt-link to="/about-cardano/">
            ...
            <div class="columns is-vcentered">
              ...
              <div class="column is-5">
                <div class="side-feature-content">
                  ...
                  <div class="divider" />
                  <p class="is-light my-3">
                    Viderer malorum sadipscing cum ei. Eu impetus perfecto sit,
                    no sea labore detraxit. Primis mediocrem necessitatibus an
                    vis. Eu impetus perfecto sit, no sea labore detraxit.
                  </p>
                </div>
              </div>
            </div>
