  ...
  <div class="hero-body">
    <div class="columns has-text-left">
      ...
      <div class="column">
        ...
        <!-- CTA end -->
        <p>
          In addition similarly to Bitcoin, <strong>Cardano</strong> usses <strong>UTXO</strong> accounting model, <strong>Extended UTXO</strong> (<strong>eUTXO</strong> - <a href="https://iohk.io/en/research/library/papers/the-extended-utxo-model/">pre-print paper - The Extended UTXO Model</a> [<a href="https://link.springer.com/chapter/10.1007/978-3-030-54455-3_37">Springer Link</a>]) specifically to enable <strong>Proof-of-Stake</strong> and formally verifiable <strong>Plutus Smart Contracts</strong>. Compared to <strong>Account based</strong> accounting model, <strong>eUTXO</strong> accounting model provides greater opportunities for scaling on both <strong>Layer 1</strong> and <strong>Layer 2</strong>.
        </p>
      </div>
    </div>
    <div class="columns has-text-left">
      <div class="column is-offset-2">
        ...
        <p class="content pl-2">
          Current Cardano Shelley Mainnet operates using <a href="https://eprint.iacr.org/2017/573">Ouroboros Praos</a> Proof-of-Stake consensus mechanism. Two major values influencing the network topology are <code>k</code> which controls the amount of stakepools the system should converge to, that is currently set to <strong>150</strong>, based on Cardano Shelley Incentivized Testnet, this should bring effective amount of pools to <i>250</i> - <i>300</i>. Another such important parameter is <code>a0</code> which drives the influence of <strong>owners stake</strong>  (also called <strong>pledge</strong> on rewards for himself and his delegates. With current setting of <code>a0</code> set to <i>0.3</i>.
        </p>
        <!-- CTA -->
        <p>
          <nuxt-link to="/begin-staking-now/" class="button k-button k-primary raised has-gradient is-fat is-bold">
