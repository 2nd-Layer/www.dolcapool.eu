export default {
  ...
  homepageText1: "DOLCA",
  homepageText2:
    "is a value-added Staking Services provider for Proof of Stake",
  homepageText3: "cryptocurrency Cardano",
  homepageText4: "",
  getStarted: "Get Started",
  introComingSoon: "Intro coming soon...",
  cardanoStakePoolText:
    "Cryptocurrency brought to the next level. Join our Stake Pool for supercharged rewards.",
  moreDetails: "More Details",
  livePoolStats: "Live Pool Stats",
  rank: "Rank",
  currentEpochStake: "Current Epoch Stake",
  lastRewardEpoch: "Last Reward Epoch",
  taxRatio: "Tax Ratio",
  taxFixed: "Tax Fixed",
